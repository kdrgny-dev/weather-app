...
export default function Search() {
  ...
  return (
    <div className='flex flex-col items-center justify-center w-full min-h-screen pt-5 gap-1'>
      <input
        type="text"
        value={query}
        onChange={onChange}
      ...
      <div className="relative w-full">
        {query.length > 3 && (
          <div className="absolute top-0 left-0 w-full bg-white dark:bg-gray-700 rounded-lg shadow-lg divide-y divide-dotted divide-gray-300">
            {results.length > 0 ? (
              results.map((result) => (
